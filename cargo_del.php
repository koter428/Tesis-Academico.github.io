                        ...
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                            <div class="box box-danger">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <a href="cargo_index.php" class="btn btn-primary btn-sm" data-title="Volver" rel="tooltip">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8">
                                                <input type="text" name="vcar_descri" class="form-control" required="" disabled=""
                                                       value="<?php echo $resultado[0]['car_descri']?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="box-footer">
                                        <button type="reset" class="btn btn-danger" data-title="Cancelar" rel="tooltip"> 
