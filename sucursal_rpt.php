                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Reporte de Sucursal</h3>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    ...
                                                                    <div class="col-lg-6 col-md-5 col-sm-5">                                                                    
                                                                            <select class="form-control select2" name="vdesde" required="">
                                                                                <?php foreach ($sucursal as $sucur) { ?>
                                                                                  <option value="<?php echo ($opcion==1)?$sucur['id_sucursal']:$sucur['suc_descri'];?>"><?php echo ($opcion==1)?$sucur['id_sucursal']:$sucur['suc_descri'];?></option>   
                                                                                <?php }?>
                                                                            </select>  
                                                                    </div>
                                                                </div>
