...
$pdf->SetTitle('REPORTE DE PEDIDOS DE VENTAS');
...
if (!empty(isset($_REQUEST['opcion']))) {
    switch ($_REQUEST['opcion']) {
        case 1://fecha            
            ...
            break;
        case 2: //proveedor
            $cabeceras = consultas::get_datos("select * from v_pedido_cabventa where art_cod in(" . $_REQUEST['vproveedor'] . ")");
            break;
        case 3: //articulo
            $cabeceras = consultas::get_datos("select * from v_pedido_cabventa "
...
//COLOR DE TABLA
        ...
        if (!empty($detalles)) {
            ...
            $pdf->Cell(165, 2, "El pedido de venta no posee detalles", 0, '', 'L', 1);
            $pdf->Ln();
            $pdf->Ln();
            $pdf->SetFont('times', '', 11);
        }
