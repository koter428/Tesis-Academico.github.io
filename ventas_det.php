...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <a onclick="confirmar(<?php echo "'".$ventas[0]['ven_cod']."_".$ventas[0]['clientes']."_".$ventas[0]['ven_fecha']."'"?>)" class="btn btn-success btn-sm" role='button'
        ...
        function editar(ven,art,dep){
            $.ajax({
                type    : "GET",
                url     : "/escuela/ventas_dedit.php?vven_cod="+ven+"&vart_cod="+art+"&vdep_cod="+dep,
                cache   : false,
                beforeSend:function(){
    ...
    <strong>'+dat[3]+'</strong> ?');            
        ...
        function add(ped,ven,art,dep){
            $.ajax({
                type    : "GET",
                url     : "/escuela/ventas_dadd.php?vped_cod="+ped+"&vven_cod="+ven+"&vart_cod="+art+"&vdep_cod="+dep,
                cache   : false,
                beforeSend:function(){
                   $("#detalles").html('<img src="img/loader.gif"/><strong>Cargando...</strong>')
                },
