...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <script>
        ...
        function editar(ven, art, dep) {
            $.ajax({
                type: "GET",
                url: "/escuela/ajustes_dedit.php?vaju_cod=" + ven + "&vart_cod=" + art + "&vdep_cod=" + dep,
                cache: false,
                beforeSend: function() {
        ...
        function add(ped, ven, art, dep) {
            $.ajax({
                type: "GET",
                url: "/escuela/ajustes_dadd.php?vaju_cod=" + ped + "&vaju_cod=" + ajustes + "&vart_cod=" + art + "&vdep_cod=" + dep,
                cache: false,
                beforeSend: function() {
                    $("#detalles").html('<img src="img/loader.gif"/><strong>Cargando...</strong>')
                },
