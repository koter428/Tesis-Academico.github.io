                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Informe de Pedidos de Ventas</h3>
                                    <div class="box-tools">
                                    </div>
                                </div>
                                                    ...
                                                    <div class="col-sm-8 col-lg-8">
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">                                                                
                                                                ...
                                                                <?php       break;
                                                                            case 2: 
                                                                                $clientes = consultas::get_datos("select * from clientes order by cli_nombre, cli_apellido");
                                                                            ?> 
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-6 col-md-6">
                                                                                    <select class="form-control select2" name="vproveedor">
                                                                                        ...
                                                                                        <?php echo $c['cli_ci']." - " . $c['cli_nombre'] . ' ' . $c['cli_apellido'];?></option>
                                                                                        <?php }?>
                                                                                    </select>
                                                                                </div>
                                                                            </div>                                                                
