...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        function editar(ven,art,dep){       
            $.ajax({
                type    : "GET",
                url     : "/escuela/transfer_dedit.php?vtra_cod="+ven+"&vdep_ori="+art+"&vdep_des="+dep,
                cache   : false,
                beforeSend:function(){
        ...
        function add(ped,ven,art,dep){
            $.ajax({
                type    : "GET",
                url     : "/escuela/transfer_dadd.php?vtra_cod="+ped+"&vtra_cod="+ajustes+"&vart_cod="+art+"&vdep_ori="+dep,
                cache   : false,
                beforeSend:function(){
                   $("#detalles").html('<img src="img/loader.gif"/><strong>Cargando...</strong>')
                },
