...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        function editar(ven,art,dep){
            $.ajax({
                type    : "GET",
                url     : "/escuela/compras_dedit.php?vcom_cod="+ven+"&vart_cod="+art+"&vdep_cod="+dep,
                cache   : false,
                beforeSend:function(){
    ...
    <strong>'+dat[3]+'</strong> ?');            
        ...
        function add(ped,ven,art,dep){
            $.ajax({
                type    : "GET",
                url     : "/escuela/compras_dadd.php?vcom_cod="+ped+"&vcom_cod="+compras+"&vart_cod="+art+"&vdep_cod="+dep,
                cache   : false,
                beforeSend:function(){
                   $("#detalles").html('<img src="img/loader.gif"/><strong>Cargando...</strong>')
                },
