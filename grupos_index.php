...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            $grupos = consultas::get_datos("select * from usuarios_grupos where nombre ilike '%".(isset($_REQUEST['buscar'])?$_REQUEST['buscar']:"")."%'order by id_grupo"); 
                                                 if (!empty($grupos)) { ?>
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-condensed table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td data-title="Nombre"><?php echo $grup['nombre'];?></td>
                                                            <td data-title="Código"><?php echo $grup['id_grupo'];?></td>
                                                            <td data-title="Acciones" class="text-center">
                                                            <?php if ($_SESSION['GRUPOS']['editar']=='t') { ?>
                                                                <a onclick="editar(<?php echo  "'".$grup['id_grupo']."_".$grup['nombre']."'";?>)" class="btn btn-warning btn-sm" role="buttom" 
                                                                   data-title="Editar" rel="tooltip" data-toggle="modal" data-target="#editar">
                                                                    <i class="fa fa-edit"></i>
                                                                </a> <?php }?> 
                                                                <?php if ($_SESSION['GRUPOS']['borrar']=='t') { ?>
                                                                <a onclick="borrar(<?php echo "'".$grup['id_grupo']."_".$grup['nombre']."'";?>)" class="btn btn-danger btn-sm" role="buttom" 
                      ...
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <form action="grupos_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                  ...
                                  <input type="hidden" name="id_grupo" id="cod" value="0">
                                  <div class="modal-body">
                                      <div class="form-group">
                                          <label class="control-label col-sm-2">Descripción:</label>
                                          <div class="col-sm-10">
        ...
        function borrar(datos){
            var dat = datos.split("_");
            $('#si').attr('href','grupos_control.php?id_grupo='+dat[0]+'&nombre='+dat[1]+'&accion=3');
