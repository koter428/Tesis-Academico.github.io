...
begin
	if ban = 1 then --insertar
		INSERT INTO ventas(
			    ven_cod, id_empleado, cli_cod, ven_fecha, tipo_venta, can_cuota, 
			    ven_plazo, ven_total, ven_estado, id_sucursal)
		    VALUES (calcular_ultimo('ventas','ven_cod'), vid_empleado, vcli_cod,current_date,
		     vtipo_venta, vcan_cuota, vven_plazo, 0, 'P', id_institucion) returning ven_cod into ultven ;	
		     if vped_cod > 0 then
