                                                        ...
                                                        <div class="panel panel-primary">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="list-group">
                                                                    ...
                                                                    <a href="cliente_rpt.php?opcion=2" class="list-group-item">Por Descripción</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-6 col-md-5 col-sm-5">                                                                    
                                                                            <select class="form-control select2" name="vdesde" required="">
                                                                                <?php foreach ($clientes as $cliente) { ?>
                                                                                  <option value="<?php echo ($opcion==1)?$cliente['cli_cod']:$cliente['cli_nombre'];?>"><?php echo ($opcion==1)?$cliente['cli_cod']:$cliente['cli_nombre'];?></option>   
                                                                                <?php }?>
                                                                            </select>  
                                                                    </div>
                                                                </div>
